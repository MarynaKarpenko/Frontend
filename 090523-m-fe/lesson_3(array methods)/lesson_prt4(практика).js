...
//   let task1 = users.filter(elem => elem.salary > 5000)
//   console.log(task1);

//-------------------------------------------------
  // Task2
// Сделайте новый массив, который будет содержать пользователь с диапазоном возраста 
// от 26 до 33 не включительно
// let task2 = users.filter(elem => elem.age > 26 && elem.age <= 33)
// console.log(task2);

// --------------------
// Task3 
// Найдите элемент, описание которого (bio) содержит ровно 6 слов
// let task3 = users.find((elem) => {
//     const words = elem.bio.split(' ')
//     return words.length === 6
// })
// console.log(task3);

// 2 вариант записи
// let task3 = users.find(elem => elem.bio.split(' ').length === 6)
// console.log(task3);
...
// вариант 1
// let task4 = users.map((elem) => {
//     let full_name_arr = elem.name.split(' ')
//     return {
...
// вариант 2
let task4 = users.map((elem) => {
    let [firstname, lastname] = elem.name.split(' ')
    return {
        firstname,
        lastname,
        age: elem.age
